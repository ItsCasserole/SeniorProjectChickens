                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form>
                                    ...
                                    <br>
                                    <br>
                                    <button type="submit" class="btn btn-primary" onclick="writeMessage('#announcementTextarea');">Post Announcement</button>
    ...
    $(document).ready(function () {
        $('#sidebarCollapse').on('click', function () {
            $('#sidebar').toggleClass('active')
				...
				function writeMessage(announcementTextarea){
					$.ajax({
		type: "post",
		url: "writeMessage.php",
		data:{
			announcementTextarea : announcementTextarea
		},
