    ...
    export default {
        ...
        methods:{
            getAllFarms: function () {
                axios.get('http://localhost/simplyfowl/api/vi.php?action=read')
            ...
            addFarm: function () {
                ...
                if (this.$refs.add_farm_form.validate())
                {
                    ...
                    var formData = app.toFormData(app.newFarm);
                    axios.post('http://localhost/simplyfowl/api/v1.php?action=create', formData)
                    .then(function (response) {
                        console.log(response);
